package com.lovegu.middleware.db.router.config;

import com.lovegu.middleware.db.router.DBRouterConfig;
import com.lovegu.middleware.db.router.DBRouterJoinPoint;
import com.lovegu.middleware.db.router.dynamic.DynamicDataSource;
import com.lovegu.middleware.db.router.dynamic.DynamicMybatisPlugin;
import com.lovegu.middleware.db.router.strategy.IDBRouterStrategy;
import com.lovegu.middleware.db.router.strategy.impl.DBRouterStrategyHashCode;
import com.lovegu.middleware.db.router.util.PropertyUtil;
    ...
    public DataSource dataSource() {
        ...
        for (String dbInfo: dataSourceMap.keySet()) {
            ...
            targetDataSources.put(dbInfo, new DriverManagerDataSource(objMap.get("url")
                    .toString(), objMap.get("username").toString(), objMap.get("password").toString()));
        }
